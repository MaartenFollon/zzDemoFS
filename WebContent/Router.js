...
jQuery.sap.declare("be.kuleuven.zz_demo_fs.Router");

sap.ui.core.routing.Router.extend("be.kuleuven.zz_demo_fs.Router", {
	...
	_findSplitApp : function(oControl) {
		sAncestorControlName = "zz_demo_fs_idAppControl";
